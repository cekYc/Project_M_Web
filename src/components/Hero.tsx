    ...
    <section className="hero" id="hero">
      ...
      <div className="hero-content">
        ...
        <p className="hero-description">
          Yeni nesil voxel tabanlı dünya üretimi. Dinamik ısı transferi,
          yapısal bütünlük simülasyonu ve sınırsız rastgele dünyalarla
        ...
        <div className="hero-stats">
          ...
          <div className="hero-stat">
            <div className="hero-stat-value">v0.1.6</div>
